      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        {view === "control" && (
          <div className="px-7 pb-7 max-w-[1100px] w-full mx-auto mt-4">
            <ControlBoard orders={orders} onOpenOrder={onOpenOrder} />
          </div>
        )}

        {/* Table */}
        {view === "list" && <div className="px-7 pb-7 max-w-[1100px] w-full mx-auto">
...
/* ─── Канбан «Контроль» ─── */
function ControlBoard({ orders, onOpenOrder }: { orders: Order[]; onOpenOrder?: (id: string) => void }) {
