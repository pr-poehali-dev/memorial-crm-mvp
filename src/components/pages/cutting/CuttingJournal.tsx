...
export default function CuttingJournal({ doneShifts }: Props) {
  ...
  const filtered = useMemo(() => doneShifts.filter(s => {
    ...
    return true;
  }), [doneShifts, filterEmp, filterPlace, rangeFrom, rangeTo]);
      ...
      <div className="shrink-0 w-[260px] space-y-3">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full bg-white border border-[#e8e8e8] rounded-[10px] px-3 py-2 text-[12px] text-[#4b4b4b] outline-none focus:border-[#b0b0b0] transition-colors"
          >
          ...
          <div className="bg-[#f4f4f5] rounded-xl p-3 space-y-2">
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-[12px]">
                <span className="text-[#6b6b6b]">Смен</span>
                <span className="font-bold text-[#1a1a1a]">{filtered.length}</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-[#6b6b6b]">Изделий</span>
                <span className="font-bold text-[#1a1a1a]">{totalP} шт.</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-[#6b6b6b]">Сырьё</span>
                <span className="font-bold text-[#6366f1]">{totalR} м²</span>
              </div>
            </div>
